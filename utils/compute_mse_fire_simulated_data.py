...
if __name__ == "__main__":
    ...
    for temperature_folder in tqdm(temperature_folders, desc="Processing..."):
        ...
        for aos_folder in aos_folders:
            ...
            path2 = aos_folder / "corrected_small.tiff"
            # path2 = aos_folder / "integrall.tiff"
            # path2 = aos_folder / "center.tiff"
            ...
            # print(img1)
            mse, rmse = compute_mse(img1, img2)
    ...
    df = pd.DataFrame(
        row_list,
        columns=["aos_folder", "GT Path", "Center Path", "mse", "rmse"],
    )
    
    df.to_csv(r'D:\Research\Wild Fire - Project\Evaluation Metric\1D\Fixed Temp\MSE\corrected_fire_gt_results.csv')
